...
export const SUBTITLE_ANCHOR_OPTIONS = Object.freeze([
  { id: 'top-left', label: 'Tren trai', horizontalAlign: 'left', verticalAlign: 'top', assAlignment: 7 },
  { id: 'top-center', label: 'Tren giua', horizontalAlign: 'center', verticalAlign: 'top', assAlignment: 8 },
  { id: 'top-right', label: 'Tren phai', horizontalAlign: 'right', verticalAlign: 'top', assAlignment: 9 },
  { id: 'middle-left', label: 'Giua trai', horizontalAlign: 'left', verticalAlign: 'middle', assAlignment: 4 },
  { id: 'middle-center', label: 'Chinh giua', horizontalAlign: 'center', verticalAlign: 'middle', assAlignment: 5 },
  { id: 'middle-right', label: 'Giua phai', horizontalAlign: 'right', verticalAlign: 'middle', assAlignment: 6 },
  { id: 'bottom-left', label: 'Duoi trai', horizontalAlign: 'left', verticalAlign: 'bottom', assAlignment: 1 },
  { id: 'bottom-center', label: 'Duoi giua', horizontalAlign: 'center', verticalAlign: 'bottom', assAlignment: 2 },
  { id: 'bottom-right', label: 'Duoi phai', horizontalAlign: 'right', verticalAlign: 'bottom', assAlignment: 3 },
])
