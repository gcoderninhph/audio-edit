...
try:
    from services.auth_store import AuthStoreError, InsufficientCreditsError, debit_user_credits, refund_user_credits
    from utils.proxy_route_helpers import get_claim_user_id
except ImportError:
    from ..services.auth_store import AuthStoreError, InsufficientCreditsError, debit_user_credits, refund_user_credits
